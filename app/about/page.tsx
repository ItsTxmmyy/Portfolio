...
export default function About() {
  return (
    <div className="p-8 text-white font-mono mt-20">
      ...
      <div className="text-center text-lg font-mono font-semibold mt-10">
        <Image
          src={imageToAdd}
          alt="Tommy"
          className="border-2 border-white mx-125 mb-4 rounded-md"
          width={300}
          height={300}
        />
        <div className="max-w-md ml-210 -mt-82 p-6 bg-grey shadow-lg rounded-lg space-y-4">
          <p className="text-xl font-semibold">MAJOR: <span className="text-red-500">Informatics and Computer Science</span></p>
